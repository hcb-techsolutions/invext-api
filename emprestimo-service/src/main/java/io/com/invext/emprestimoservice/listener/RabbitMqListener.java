package io.com.invext.emprestimoservice.listener;
...
import io.com.invext.emprestimoservice.dto.SolicitacaoDto;
...
public class RabbitMqListener {
	...
	@RabbitListener(queues = "${app.rabbitmq.emprestimo.queue}", 
    ...
    public void listen(SolicitacaoDto solicitacaoDto, Channel channel, 
		...
		if (atendente == null) {
            log.warn("Sem atendente disponivel para solicitação de emprestimo! Favor aguarde na fila de espera");
